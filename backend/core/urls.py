...
from core.views import LandingPageView, JoinRequestView, JoinRequestListView, process_join_request, supplier_report, buyer_report, DashboardView, UserProfileView, UserPasswordChangeView, login_success, SupplierListView, CreateSupplierView, SupplierUpdateView, SupplierDeleteView, BuyerListView, CreateBuyerView, BuyerUpdateView, BuyerDeleteView, WorkerListView, CreateWorkerView, WorkerDeleteView, ManagerListView, ManagerCreateView, ManagerDeleteView, TransactionListView, RecordSupplyView, RecordSaleView, SiteListView, SiteDetailView, SaveMilkRecordView, ChatView, NotificationListView, TrainingView, TrainingResourceCreateView, TrainingResourceDeleteView
